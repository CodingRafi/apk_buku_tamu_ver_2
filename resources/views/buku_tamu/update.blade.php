                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="mt-2 form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                                            value="{{ old('alamat') }}" placeholder="Alamat tamu yang berkunjung">{{ $data->alamat, old('alamat') }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">
